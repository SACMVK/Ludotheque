...
function afficherElement($individu) {
    // stefan : @Ahmad afficher un individu
    $affichage = "";
    return $affichage;
}

function afficherListeElements($liste_individu) {
    // stefan : @Ahmad afficher une liste d'individus
    ...
    foreach ($liste_individu as $value) {
