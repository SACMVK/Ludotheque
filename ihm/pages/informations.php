...
<div class="article-clean" id="aide">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="intro">
                    <h1 class="text-center">aide</h1><img class="img-responsive" src="ihm/img/pc.jpg"</div>
...
<div class="article-clean" id="contact">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="intro">
                    <h1 class="text-center">contact</h1><img class="img-responsive" src="ihm/img/pc.jpg"</div>
