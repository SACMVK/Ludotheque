...
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Demande d'emprunt", "#idUser# vous demande s'il peut vous emprunter votre jeu #idJeu_p# du #dateDebut# au #dateFin#.", "Demande d'emprunt", "Vous avez demandé à #idUser# de lui emprunter son jeu de #idJeu_p# du #dateDebut# au #dateFin#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Validation emprunt", "Vous avez validé la demande d'emprunt de votre jeu #idJeu_p# par #iduser# du #dateDebut# au #dateFin#.", "Validation de votre demande d'emprunt", "#iduser# a validé votre demande d'emprunt de son jeu #idJeu_p# du #dateDebut# au #dateFin#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Annulation emprunt", "Vous avez refusé la demande d'emprunt de votre jeu #jeu_p# par #iduser# du #dateDebut# au #dateFin#. La demande d'emprunt est close.", "Demande d'emprunt rejetée", "Votre demande d'emprunt du jeu #idjeup# à #iduser# du #dateDebut# au #dateFin# a été rejetée. La demande d'emprunt est close.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Demande d'emprunt :  nouvelles dates", "Vous avez proposé à #iduser# de nouvelles dates pour sa demande d'emprunt de votre jeu #idjeup# : du #dateDebut# au #dateFin#.", "Demande d'emprunt :  nouvelles dates", "#iduser# vous propose de nouvelles dates pour votre demande d'emprunt de son jeu #idjeup# : du #dateDebut# au #dateFin#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Demande de modification de dates rejetée", "#iduser# n'a pas accepté les nouvelles dates d'emprunt que vous lui aviez proposé. La demande d'emprunt est close.", "Rejet nouvelles dates d'emprunt", "Vous avez rejeté les nouvelles dates d'emprunt du jeu #idjeup# de #iduser (du #dateDebut# au #dateFin#). La demande d'emprunt est close.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Envoi du jeu", "Vous avez envoyé votre jeu #idjeu# à #iduser# le #date#.", "Envoi du jeu", "#iduser# vous a envoyé son jeu #idjeu# le #date#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Réception du jeu", "#iduser confirme qu'il a bien reçu votre jeu #idjeu# le #date#.", "Réception du jeu", "Vous avez confirmé à #iduser# que vous avez bien reçu son jeu #idjeu# le #date#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Renvoi du jeu", "#iduser# vous a renvoyé votre jeu #idjeu# le #date#.", "Renvoi du jeu", "Vous avez confirmé à #iduser# que vous lui avez renvoyé son jeu #idjeu# le #date#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Réception du jeu", "Vous avez confirmé à #iduser# que vous avez bien reçu votre jeu #idjeu# le #date#", "Réception du jeu", "#iduser# vous confirme qu'il a bien reçu son jeu #idjeu# le #date#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Retard d'envoi", "Vous deviez envoyer votre #jeup# à #iduser# le #date#, vous êtes en retard.", "Retard de renvoi", "Vous deviez renvoyer son #jeup# à #iduser# le #date#, vous êtes en retard.");
