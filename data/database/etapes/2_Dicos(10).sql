...
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Demande d'emprunt", "#nomEmprunteur# vous demande s'il peut vous emprunter votre jeu #nomJeu# du #dateDebut# au #dateFin#.", "Demande d'emprunt", "Vous avez demandé à #nomPreteur# de lui emprunter son jeu de #nomJeu# du #dateDebut# au #dateFin#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Validation emprunt", "Vous avez validé la demande d'emprunt de votre jeu #nomJeu# par #nomEmprunteur# du #dateDebut# au #dateFin#.", "Validation de votre demande d'emprunt", "#nomPreteur# a validé votre demande d'emprunt de son jeu #nomJeu# du #dateDebut# au #dateFin#.");
...
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Envoi du jeu", "Vous avez envoyé votre jeu #nomJeu# à #nomEmprunteur# le #date#.", "Envoi du jeu", "#nomPreteur# vous a envoyé son jeu #nomJeu# le #date#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Réception du jeu", "#nomEmprunteur# confirme qu'il a bien reçu votre jeu #nomJeu# le #date#.", "Réception du jeu", "Vous avez confirmé à #nomPreteur# que vous avez bien reçu son jeu #nomJeu# le #date#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Renvoi du jeu", "#nomEmprunteur# vous a renvoyé votre jeu #nomJeu# le #date#.", "Renvoi du jeu", "Vous avez confirmé à #nomPreteur# que vous lui avez renvoyé son jeu #nomJeu# le #date#.");
INSERT INTO notification (sujetPreteur, corpsPreteur, sujetEmprunteur, corpsEmprunteur) VALUES ("Réception du jeu", "Vous avez confirmé à #nomEmprunteur# que vous avez bien reçu votre jeu #nomJeu# le #date#. Le prêt est terminé.", "Réception du jeu", "#nomPreteur# vous confirme qu'il a bien reçu son jeu #nomJeu# le #date#. Le prêt est terminé.");
